object frmPedidoEtiqueta: TfrmPedidoEtiqueta
  ...
  object cdsEtiquetas: TClientDataSet
    ...
    Top = 80
    Data = {
      A50000009619E0BD010000001800000006000000000003000000A50004495445
  ...
  object rvPersonalizado: TRvProject
    Engine = RvSystem3
    ProjectFile = 'C:\Empresa\Etiquetas\Relatorio\rvZebra1Coluna.rav'
    Left = 296
    Top = 233
  end
  object rvCdsEstiquetas: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = cdsEtiquetas
    Left = 344
    Top = 235
  end
  object rvPersonalizado2: TRvProject
    Engine = RvSystem3
    ProjectFile = 'C:\Empresa\Etiquetas\Relatorio\rvZebra1ColunaPrecos.rav'
    Left = 296
    Top = 267
  end
  object rvPersonalizado3: TRvProject
    Engine = RvSystem3
    ProjectFile = 'C:\Empresa\Etiquetas\Relatorio\rvZebra1ColunaBarras.rav'
    Left = 296
    Top = 299
  end
end
