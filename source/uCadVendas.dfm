object frmCadVendas: TfrmCadVendas
  ...
  object pnlSuperior: TPanel
    ...
    object Label11: TLabel
      ...
      Width = 49
      Height = 13
      Caption = 'E&ndere'#231'o:'
      FocusControl = edtENDCLI
    end
    ...
    object edtNMVEND: TComboBox
      ...
      ItemHeight = 16
      TabOrder = 4
      OnExit = edtNMVENDExit
      OnKeyPress = edtNMVENDKeyPress
    end
    ...
    object edtNRFONE: TMaskEdit
      ...
      TabOrder = 7
      Text = '    -    '
      OnKeyPress = edtNRFONEKeyPress
    end
    object edtENDCLI: TEdit
      Left = 70
      Top = 104
      Width = 434
      Height = 21
  ...
  object pnlEntrada: TPanel
    ...
    object edtCDBARR: TEdit
      ...
      Width = 121
      Height = 21
      Hint = 'Digite o c'#243'digo de barras do item'
      MaxLength = 14
      TabOrder = 0
  ...
  object qryItens: TQuery
    ...
    object qryItensITV_NMPROD: TStringField
      FieldKind = fkLookup
      FieldName = 'ITV_NMPROD'
    ...
    object qryItensITV_VLUNIT: TCurrencyField
      FieldKind = fkLookup
      FieldName = 'ITV_VLUNIT'
      LookupDataSet = qryProdutos
      LookupKeyFields = 'PRO_CDBARR'
    ...
    object qryItensITV_VLSUBT: TCurrencyField
    ...
    object qryItensITV_VLDES2: TStringField
      FieldKind = fkCalculated
  ...
  object qryInclusao: TQuery
    ...
    SQL.Strings = (
        ...
        'OD, ITV_VLUNI2, ITV_VLDESC)'
      
        'VALUES (:pNRVEND, :pNRITEM, :pCDPROD, :pQTPROD, :pVLUNI2, :pVLDE' +
        'SC) ')
    Left = 152
    Top = 192
    ParamData = <
  ...
  object qryLocProduto: TQuery
    DatabaseName = 'DBEtiqueta'
    SQL.Strings = (
      'Select EST_CDLOJA, EST_CDPROD from "SACEST.DB" '
      'Where (EST_CDLOJA=:pCDLOJA) And (EST_CDPROD=:pCDPROD)')
    Left = 392
    Top = 136
    ParamData = <
  ...
  object qryIncProdutoEst: TQuery
    DatabaseName = 'DBEtiqueta'
    SQL.Strings = (
