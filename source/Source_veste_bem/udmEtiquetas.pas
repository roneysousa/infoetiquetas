...
uses
  SysUtils, Classes, DB, DBTables, Forms, DBIProcs, DBClient;
...
type
  TdmEtiquetas = class(TDataModule)
    ...
    tbProdutosPRO_NMSECA: TStringField;
    tbProdutosPRO_NMGRUP: TStringField;
    ...
    tbParametrosPAR_TAM_CODIGO: TStringField;
    tbParametrosPAR_CDTAM01: TFloatField;
    tbParametrosPAR_CDTAM02: TFloatField;
    qryValorPrazo: TQuery;
  ...
  public
    ...
    Function GetValorAprazo(aProduto : String): Double;   
  end;
...
function TdmEtiquetas.GetValorAprazo(aProduto: String): Double;
begin
     With qryValorPrazo do
      begin
           SQL.Clear;
           Close;
           SQL.Add('Select PRO_CDPROD, PRO_VLAPRA from "SACPRO.DBF" Where (PRO_CDPROD = :pCDPROD)');
           ParamByName('pCDPROD').AsString := uFuncoes.StrZero(aProduto,13);
           Open;
           //
           If (recordCount > 0) Then
