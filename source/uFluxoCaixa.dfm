object frmFluxoCaixa: TfrmFluxoCaixa
  ...
  object qryDados: TQuery
    ...
    Left = 160
    Top = 32
    object qryDadosMCA_TPMOVI: TStringField
      FieldName = 'MCA_TPMOVI'
      Origin = 'DBETIQUETA."SACMCA.DBF".MCA_TPMOVI'
      Size = 1
    end
    object qryDadosMCA_TOTAL: TFloatField
      FieldName = 'MCA_TOTAL'
      DisplayFormat = '###,###,##0.#0'
      EditFormat = '###,###,##0.#0'
    end
    object qryDadosMCA_CDNATU: TStringField
      FieldName = 'MCA_CDNATU'
      Origin = 'DBETIQUETA."SACMCA.DBF".MCA_CDNATU'
      Size = 3
    end
    object qryDadosMCA_NMNATU: TStringField
      FieldKind = fkLookup
    ...
    object qryDadosMCA_NMDESC: TStringField
