object frmImpEtiTrans: TfrmImpEtiTrans
  Left = 279
  Top = 187
  ...
  object qryItens: TQuery
    ...
    object qryItensTRP_VLVEND: TCurrencyField
      FieldKind = fkLookup
      FieldName = 'TRP_VLVEND'
      LookupDataSet = qryProdutos
      LookupKeyFields = 'PRO_CDBARR'
  ...
  object qryTOTETI: TQuery
    DatabaseName = 'DBEtiqueta'
    SQL.Strings = (
      'Select SUM(TRP_QTPROD) TRP_QUANT from SACTRP '
      'Where (TRP_NRSEQU = :pNRSEQU)')
    Left = 304
    Top = 48
    ParamData = <
      item
    ...
    object qryTOTETITRP_QUANT: TFloatField
      FieldName = 'TRP_QUANT'
      Origin = 'DBETIQUETA."SACTRP.DB".TRP_QTPROD'
    end
  end
