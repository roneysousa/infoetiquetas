    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object Label8: TLabel
          ...
          Width = 150
          Height = 13
          Caption = 'Modelo de Impress'#227'o de Venda'
          FocusControl = dbeMDIMPR
          Visible = False
        end
        ...
        object Label13: TLabel
          ...
          Width = 107
          Height = 13
          Caption = 'Posi'#231#227'o Atual Etiqueta'
          FocusControl = DBEdit9
        end
        object dbeMDIMPR: TDBEdit
          Left = 456
          Top = 82
          Width = 65
          Height = 21
          DataField = 'PAR_MDIMPR'
          DataSource = dsParametros
          TabOrder = 0
          Visible = False
          OnExit = dbeMDIMPRExit
          OnKeyPress = dbeMDIMPRKeyPress
        end
        object DBRadioGroup2: TDBRadioGroup
          ...
          Width = 417
          Height = 140
          Caption = '[ Tamanho do Papel da Etiqueta ]'
          Columns = 2
          DataField = 'PAR_PADRAO_ETIQ'
          DataSource = dsParametros
          Items.Strings = (
            'A4'
            'A5'
            'Zebra 3.00 x 3.80 - 1 Coluna'
            'A4 3 X 10'
            'A4 16 X 6'
            'A4 290 X 10'
            'A4 G'#244'ndula'
        ...
        object DBRadioGroup1: TDBRadioGroup
          ...
          Width = 249
          Height = 41
          Caption = '[ Exibir pre'#231'os na etiqueta de c'#243'digo de barras ]'
          Columns = 2
          DataField = 'PAR_FLPRECO'
          DataSource = dsParametros
          Items.Strings = (
            'Sim'
            'N'#227'o')
        ...
        object DBRadioGroup4: TDBRadioGroup
          ...
          Width = 249
          Height = 41
          Caption = '[ Mostrar R'#233'gua]'
          Columns = 2
          DataField = 'PAR_MOSTRAR_REGUA'
          DataSource = dsParametros
          Items.Strings = (
            'Sim'
            'N'#227'o')
        ...
        object DBRadioGroup5: TDBRadioGroup
          ...
          Width = 134
          Height = 41
          Caption = '[ C'#243'digo Alfan'#250'merico  ]'
          Columns = 2
          DataField = 'PAR_CDALFANUMERICO'
          DataSource = dsParametros
          Items.Strings = (
            'Sim'
            'N'#227'o')
